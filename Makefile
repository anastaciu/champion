...
arbitro_main.o: source_arbitro/main.c source_arbitro/defaults.h source_arbitro/user_interface.h global_interface.h
...
cliente_main.o: source_cliente/main.c source_cliente/user_interface.h
...
game_000_main.o: game_0/main.c game_0/logic_interface.h game_0/dictionary.h game_0/user_interface.h global_interface.h
	gcc -c -Wall -Wextra -pedantic game_0/main.c -o game_000_main.o

game_user.o: game_0/user.c global.c
	gcc -c -Wall -Wextra -pedantic game_0/user.c -o game_user.o

game_logic.o: game_0/logic.c game_0/user_interface.h
